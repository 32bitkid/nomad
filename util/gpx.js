...
(function() {
  var Gpx, addDistanceFromStart, fs, latlon, processRawToPointArray, q, readFile, toGeoJSONPoint, xmlParser, xpath;
  ...
  processRawToPointArray = function(trail, coords) {
    var accumulator, currentPoint, distanceToPrevious, index, point, previousPoint, _i, _len, _results;
  ...
  Gpx = (function() {
    ...
    Gpx.prototype.toPointArray = function(id) {
      ...
      return processRawToPointArray(id, coordinates);
    };
